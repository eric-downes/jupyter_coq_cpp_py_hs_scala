...
# ^^^ always keep that as first line "syntax = edrevo/dockerfile-plus"
...
RUN apt-get update && apt-get install -y coq coqide default-jre curl
...
jupyter notebook --ip=127.0.0.1 --port=8888 --allow-root --NotebookApp.token=''
